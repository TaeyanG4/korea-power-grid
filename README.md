...
- Phase 3 — historical backfill: Checkpoint 1 (recent 3 years) complete; Checkpoint 2 (recent 5 years) complete (`PASS WITH OBSERVATIONS`); Checkpoint 3 (recent 8 years) next
